...
// Định nghĩa chân pin cảm biến lửa và MQ5
#define FLAME_PIN               18
#define MQ5_PIN                 32

// Ngưỡng giá trị cho cảm biến MQ5 và cảm biến lửa
#define MQ5_THRESHOLD           800
#define FLAME_THRESHOLD         LOW // Giả sử khi chân pin cảm biến lửa xuất hiện mức LOW là phát hiện lửa

#define PHONE_NUMBER            "037*******" // nhập số điện thoại
...
void setup() 
{
    ...
    // Khai báo chân pin cảm biến MQ5 là đầu vào
...
{     
    ...
    // Kiểm tra phát hiện khí gas từ cảm biến MQ5
    int MQ5_value = analogRead(MQ5_PIN);
    Serial.print("Giá trị MQ5: ");
